package com.seed4j.sample.shared.collection.domain;
...
@UnitTest
class Seed4jsampleCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class Seed4jsampleCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = Seed4jsampleCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = Seed4jsampleCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class Seed4jsampleCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = Seed4jsampleCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = Seed4jsampleCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class Seed4jsampleCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = Seed4jsampleCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = Seed4jsampleCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class Seed4jsampleMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = Seed4jsampleCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = Seed4jsampleCollections.immutable(input);
